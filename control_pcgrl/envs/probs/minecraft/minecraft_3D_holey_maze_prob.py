...
from control_pcgrl.envs.probs.holey_prob_3D import HoleyProblem3D
...
from control_pcgrl.envs.probs.minecraft.mc_render import (erase_3D_path, spawn_3D_bordered_map, spawn_3D_doors, spawn_3D_maze, spawn_3D_border, spawn_3D_path, 
...
from control_pcgrl.envs.probs.minecraft.minecraft_pb2 import BEDROCK, WOODEN_SLAB, LEAVES, TORCH, PURPUR_SLAB, WOOL
import ray
