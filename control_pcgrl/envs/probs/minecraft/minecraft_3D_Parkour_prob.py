...
from control_pcgrl.envs.helper_3D import get_range_reward, get_tile_locations, calc_certain_tile, get_floor_dist, get_type_grouping, get_changes
from control_pcgrl.envs.probs.minecraft.minecraft.engine import State,BFSAgent,AStarAgent


class Minecraft3DParkourProblem(Problem):
    def __init__(self):
        super().__init__()
        self._width = 116
        self._height = 16
