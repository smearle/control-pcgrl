...
from control_pcgrl.envs.helper_3D import get_path_coords, get_range_reward, get_tile_locations, calc_num_regions, \
    calc_longest_path, debug_path, plot_3D_path, remove_stacked_path_tiles, run_dijkstra
from control_pcgrl.envs.probs.minecraft.mc_render import (erase_3D_path, init_player_view, spawn_3D_maze, spawn_3D_border, spawn_3D_path,
...
# from control_pcgrl.test3D import plot_3d_map
...
class Minecraft3DmazeProblem(Problem3D):
    ...
    def get_stats(self, map):
        ...
        # for erasing the path of the previous iteration in Minecraft
        ...
        # start_time = timer()
        self.path_length, self.ordered_path, self.n_jump = calc_longest_path(map, map_locations, ["AIR"], get_path=self.render_path)
    ...
    def render_path_change(self, map, path_coords, old_path_coords, ordered_path=None, **kwargs):
