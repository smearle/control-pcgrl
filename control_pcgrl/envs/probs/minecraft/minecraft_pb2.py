...
# source: src/main/proto/minecraft.proto
...
Cube = _reflection.GeneratedProtocolMessageType('Cube', (_message.Message,), dict(
  DESCRIPTOR = _CUBE,
  __module__ = 'src.main.proto.minecraft_pb2'
...
FillCubeRequest = _reflection.GeneratedProtocolMessageType('FillCubeRequest', (_message.Message,), dict(
...
Uuids = _reflection.GeneratedProtocolMessageType('Uuids', (_message.Message,), dict(
  DESCRIPTOR = _UUIDS,
  __module__ = 'src.main.proto.minecraft_pb2'
...
SpawnEntities = _reflection.GeneratedProtocolMessageType('SpawnEntities', (_message.Message,), dict(
...
SpawnEntity = _reflection.GeneratedProtocolMessageType('SpawnEntity', (_message.Message,), dict(
...
_MINECRAFTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='setLoc',
    full_name='dk.itu.real.ooe.MinecraftService.setLoc',
    index=6,
    containing_service=None,
    input_type=_POINT,
    output_type=_POINT,
  ...
  _descriptor.MethodDescriptor(
    name='setRot',
    full_name='dk.itu.real.ooe.MinecraftService.setRot',
    index=7,
    containing_service=None,
    input_type=_POINT,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
  ...
  _descriptor.MethodDescriptor(
    name='initDataGen',
    full_name='dk.itu.real.ooe.MinecraftService.initDataGen',
    index=8,
    containing_service=None,
    input_type=_POINT,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
  ...
  _descriptor.MethodDescriptor(
    name='getHighestYAt',
    full_name='dk.itu.real.ooe.MinecraftService.getHighestYAt',
    index=9,
    containing_service=None,
    input_type=_POINT,
    output_type=_POINT,
