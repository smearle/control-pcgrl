...
from control_pcgrl.envs.probs.zelda2.zelda2_prob import Zelda2Problem


class Zelda2CtrlProblem(Zelda2Problem):
    def __init__(self, cfg: Config):
        super(Zelda2CtrlProblem, self).__init__(cfg=cfg)
