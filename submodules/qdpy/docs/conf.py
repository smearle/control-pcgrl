...
latex_documents = [
    (master_doc, 'qdpy.tex', 'qdpy Documentation',
     'Leo Cazenille', 'manual'),
]
...
man_pages = [
    (master_doc, 'qdpy', 'qdpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qdpy', 'qdpy Documentation',
     author, 'qdpy', 'One line description of project.',
     'Miscellaneous'),
]
