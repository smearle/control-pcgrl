...
#SBATCH --output=rl_runs/pcgrl_minecraft_3D_maze_ctrl_narrow3D_vanilla_chng-1.0_lr-5.0e-06_testingnjump_%j.out
...
start=$SECONDS
python rl/train_ctrl.py --load_args minecraft_3D_maze_ctrl_narrow3D_vanilla_chng-1.0_lr-5.0e-06_testingnjump
do
