...
#SBATCH --output=rl_runs/pcgrl_binary_ctrl_holey_narrowholey_vanilla_chng-0.8_lr-5.0e-06_test3Dmaze_%j.out
...
start=$SECONDS
python rl/train_ctrl.py --load_args binary_ctrl_holey_narrowholey_vanilla_chng-0.8_lr-5.0e-06_test3Dmaze
do
