    ...
    def get_actions(self):
        ...
        if level[row,col] == '#':
            ...
            if row==bottom:
                ...
                if col!=left_end and (level[row,col-1]=='G' or level[row,col-1]=='E' or level[row,col-1]=='.') and (
                ...
                if col!=right_end and (level[row,col+1]=='G' or level[row,col+1]=='E' or level[row,col+1]=='.') and (
            ...
            if row!=bottom:
                ...
                if level[row+1,col]!='b' and level[row+1,col]!='B' and level[row+1,col]!='#':actions.append("down")
...
class PriorityQueue:
    ...
    def display(self):
        for i in range (len(self.elements)):
            print(self.elements[i][2].row , self.elements[i][2].col,self.elements[i][2].score,self.elements[i][0],self.elements[i][1] )
    ...
    for i in range(map2d.h):
        for j in range(map2d.w):
            if map2d[i,j]=='M':
                ...
                col=j
                break
    while row!= map2d.h-1 and map2d[row+1,col]!='B' and map2d[row+1,col]!='b' and map2d[row+1,col]!='#' and map2d[row,col]!='-':
        row = row+1
        if map2d[row,col]=='G':
